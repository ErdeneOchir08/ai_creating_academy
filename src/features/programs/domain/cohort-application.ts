...
const savedApplicationSchema = z.object({
    ...
    student_birth_date: z.string().date().nullable(),
    signer_role: z.enum(['self', 'guardian']).nullable(),
    signer_name: z.string().nullable(),
    signer_email: z.string().nullable(),
    signer_phone: z.string().nullable(),
    signer_registration_number: z.string().nullable(),
    signer_relationship: z.string().nullable(),
    rejection_reason: z.string().nullable(),
    submitted_at: z.string().nullable(),
    contract_acknowledged_at: z.string().nullable(),
    signed_at: z.string().nullable(),
    signature_method: z.enum(['authenticated_account', 'email_otp']).nullable(),
...
const contractSnapshotApplicationDetailsSchema = z.object({
    ...
    student_birth_date: z.string().date(),
    signer_role: z.enum(['self', 'guardian']),
    signer_name: z.string(),
    signer_email: z.string(),
    signer_phone: z.string(),
    signer_registration_number: z.string(),
    signer_relationship: z.string(),
    submitted_at: z.string(),
    contract_acknowledged_at: z.string(),
    signed_at: z.string(),
    signature_method: z.enum(['authenticated_account', 'email_otp']),
    signer_email_verified_at: z.string(),
    signature_statement: z.string(),
    signature_statement_version: z.string(),
