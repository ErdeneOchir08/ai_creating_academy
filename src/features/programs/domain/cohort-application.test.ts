    ...
    it('validates the complete admin audit snapshot', () => {
        const snapshot = parseAdminApprovedApplicationContractSnapshot({
            ...
            application_details: {
                ...
                status: 'approved',
                student_birth_date: '2000-01-15',
                signer_role: 'self',
                signer_name: 'Бат Болд',
                signer_email: 'student@example.com',
                signer_phone: '99112233',
                signer_registration_number: 'УБ00111512',
                signer_relationship: 'Өөрөө',
                submitted_at: '2026-08-03T06:00:00.000Z',
                contract_acknowledged_at: '2026-08-03T05:59:00.000Z',
                signed_at: '2026-08-03T05:59:00.000Z',
                signature_method: 'authenticated_account',
                signer_email_verified_at: '2026-08-03T05:59:00.000Z',
                signature_statement: 'Би гэрээг зөвшөөрч байна.',
                signature_statement_version: 'mn-v1',
